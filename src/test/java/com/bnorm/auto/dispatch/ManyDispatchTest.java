...
public class ManyDispatchTest extends TestCase {

  @Test
  public void test() throws Exception {
    JavaSourcesSubject.assertThat(JavaFileObjects.forResource("good/ManyDispatchMethod.java"),
                      ...
                      .and()
                      .generatesSources(JavaFileObjects.forResource("expected/AutoDispatch_ManyDispatchMethod.java"));
  }
}
